...
def main(args):
    ...
    if dataset_name == 'MNIST':
        ...
        dataset = GTSRB(root=os.path.expanduser("~/.cache"), download=True, split='test', transform=clip_transform)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clip_model', default='RN50', type=str, choices=['RN50', 'RN101', 'RN50x4', 'ViT-B/32', 'ViT-B/16'])
    ...
    # dataset 
    parser.add_argument('--dataset', default='GTSRB', choices=['MNIST', 'STL10', 'CIFAR10',
