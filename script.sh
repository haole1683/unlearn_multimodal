...
python unlearn_stage3_test_generator_gen_noise.py --clip_model=RN50x4 --device=cuda:0 --dataset=stl10 --gen_which=both
python unlearn_stage3_test_generator_gen_noise.py --clip_model=RN50x4 --device=cuda:0 --dataset=cifar10
python unlearn_stage3_test_generator_gen_noise.py --device="cuda:0" --gen_which=all --overwrite --update_z_freq=1000000 --text_prompt_stragegy=fixed
